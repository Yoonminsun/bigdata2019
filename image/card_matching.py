...
# 경계선 검출
# contour, hier = cv2.findContours(card_4,cv2.RETR_LIST,cv2.CHAIN_APPROX_SIMPLE)
# for i in contour:
#     cv2.drawContours(card_4,[i],0,(255,0,0),3)
#
...
res = cv2.matchTemplate(card_4,card,cv2.TM_CCOEFF)
