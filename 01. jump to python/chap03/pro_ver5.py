...
while True:
    ...
    if fticket and count%7==0 and fee!='무료' and buy:
        fticket-=1
        print("축하합니다. 1주년 이벤트에 당첨되었습니다. 여기 무료 티켓을 발행합니다. 잔여 무료티켓 %d장"%fticket)

    elif dticket and count%4==0 and fee!='무료'and buy:
        dticket-=1
        print("축하합니다. 연간회원권 구매 이벤트에 당첨되셨습니다. 연간 회원 할인 티켓을 발행합니다. 잔여 할인티켓 %d장"%dticket)
